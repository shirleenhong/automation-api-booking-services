...
public class ProductsControllerTest {
    ...
    public void shouldSaveUpdateIndiaProducts() throws Exception {
        ...
        when(service.saveProduct(anyString(), any(IndiaProduct.class), anyBoolean())).thenReturn("updatedResult");
        ...
        verify(service, times(1)).saveProduct(anyString(), any(IndiaProduct.class), anyBoolean());
    }
