...
//    {
//
//        MockMultipartFile mockMultipartFile = new MockMultipartFile("user-file", "test", "text/plain", "test data".getBytes());
//
//        MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.multipart("/air-transactions").file(mockMultipartFile);
//
//        mockMvc.perform(builder).andExpect(status().isFound()).andReturn().getResponse();
//        verify(service, times(1)).delete(anyString());
//    }
//
