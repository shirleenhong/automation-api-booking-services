...
public class AirTransactionController {
	...
	@ApiOperation(value = "[Maintenance] Inserts new Air Transactions.")
	@ResponseBody
	...
	@ResponseBody
	public ResponseEntity<Map<String, String>> uploadAirTransction(@RequestParam("file") MultipartFile file) throws Exception {
