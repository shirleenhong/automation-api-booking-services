...
class ValidationConstants {
    ...
    static final String CLIENT_ENTITY_NAME_REGEX = "^[a-zA-Z0-9. ]*$";
    static final String CLIENT_ENTITY_NAME_FORMAT_ERROR_MSG = "clientEntityName should be alphanumeric (spaces and periods (.) are allowed)";
    ...
    static final String ADDRESS_LINE1_REGEX = "^[a-zA-Z0-9. ]*$";
    static final String ADDRESS_LINE1_FORMAT_ERROR_MSG = "entityAddressLine1 should be alphanumeric (spaces and periods (.) are allowed)";
    ...
    static final String ADDRESS_LINE2_REGEX = "^[a-zA-Z0-9. ]*$";
    static final String ADDRESS_LINE2_FORMAT_ERROR_MSG = "entityAddressLine2 should be alphanumeric (spaces and periods (.) are allowed)";
    ...
    static final String POSTAL_CODE_REGEX = "^[0-9]*$";
    static final String POSTAL_CODE_FORMAT_ERROR_MSG = "postalCode should be numeric";
    ...
    static final String CITY_REGEX = "^[a-zA-Z0-9]*$";
    static final String CITY_FORMAT_ERROR_MSG = "city should be alphanumeric";
